...
public class Task3 {
    public static void main(String[] args) {
        class_cat Pushok = new class_cat("Pushok", "White");
        class_cat Barsik = new class_cat("Barsik", "Black");
        class_cat Tuzik = new class_cat("Barsik", "Black");
        
        HashSet<class_cat> cats = new HashSet<>(Arrays.asList(Pushok, Barsik, Tuzik));
        for (var el : cats) {
            el.Print();
